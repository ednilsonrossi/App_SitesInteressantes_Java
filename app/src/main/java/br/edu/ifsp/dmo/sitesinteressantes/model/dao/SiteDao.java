...
public class SiteDao {
    ...
    public void create(Site site){
        ...
        values.put(DatabaseContract.TableSite.COLUMN_URL, site.getUrl());
        values.put(DatabaseContract.TableSite.COLUMN_TAG_ID, tagId);

        mDatabase = mHelper.getWritableDatabase();
        mDatabase.insert(
                DatabaseContract.TableSite.TABLE_NAME,
                null,
                values
        );
        mDatabase.close();
    ...
    public List<Site> recuperateAll(){
        String query = "SELECT " +
                ...
                " ON S." + DatabaseContract.TableSite.COLUMN_TAG_ID + " = T." + DatabaseContract.TableTag._ID +
